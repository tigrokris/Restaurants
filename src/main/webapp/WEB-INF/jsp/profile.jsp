...
<%@ taglib prefix="restaurants" tagdir="/WEB-INF/tags" %>
        ...
        <div class="shadow">
            ...
            <div class="view-box">
                <form:form modelAttribute="userTo" class="form-horizontal" method="post"
                    ...
                    <restaurants:inputField label="Name" name="name"/>
                    <restaurants:inputField label="Email" name="email"/>
                    <restaurants:inputField label="Password" name="password" inputType="password"/>
